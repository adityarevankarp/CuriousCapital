      ...
      <div className="overflow-x-hidden">
        ...
        <div className="relative mx-auto sm:mx-0 md:mx-6 lg:mx-24 xl:mx-78 2xl:mx-88 4xl:mx-98 imac:mx-180">
          <div className="relative z-1 flex flex-col justify-center items-center p-20 mx-auto">
            ...
            <div className="logos flex gap-10 my-7">
              <a
                href="https://twitter.com/curiouscapital_"
                target="_blank"
                rel="noopener noreferrer"
              >
                <span class="[&>svg]:h-20 [&>svg]:w-20">
                  <svg
              ...
              <span class="[&>svg]:h-20 [&>svg]:w-20 [&>svg]:fill-[#0077b5]">
          ...
          {/* <div className="spin scale-125 mx-auto">
            <Spinner />
          </div> */}
        </div>
