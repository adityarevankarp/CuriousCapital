          ...
          <div className="relative z-1 flex flex-col justify-center items-center p-10">
            ...
            <div className="logos sm:flex gap-20 my-4 p-16 sm:p-10 items-center justify-center">
              ...
              <div class="w-full h-40 flex items-center justify-center cursor-pointer my-10 sm:my-0">
                <div class="relative inline-flex items-center justify-start py-3 pl-4 pr-12 overflow-hidden font-semibold shadow text-indigo-600 transition-all duration-150 ease-in-out rounded hover:pl-10 hover:pr-6 bg-gray-50 dark:bg-gray-900 dark:text-white dark:hover:text-gray-200 dark:shadow-none group">
