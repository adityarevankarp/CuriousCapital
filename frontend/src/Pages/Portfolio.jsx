          ...
          <div className="relative z-1 flex flex-col justify-center items-center p-4 sm:p-20 sm:pt-5   ">
            ...
            <div className="grid grid-cols-2 justify-items-stretch xxs:m-10 gap-5 xs:grid-cols-3 s:grid-cols-4 s:gap-5 sm:grid-cols-4 lg:grid-cols-4 ssm:grid-cols-2 ssm:gap-x-16">
              <Card
                logo_url={p11}
                logo_name={"Binance"}
                modalText={modalTextArr.binance}
                logo_link={modalLinks.binance}
              />
              <Card
                logo_url={p12}
                logo_name={"Shuffle"}
                modalText={modalTextArr.shuffle}
                logo_link={modalLinks.shuffle}
              />
            </div>
            ...
            <div className="grid grid-cols-2 justify-items-stretch xxs:m-10 gap-5 xs:grid-cols-3 s:grid-cols-4 s:gap-5 sm:grid-cols-4 lg:grid-cols-4 ssm:grid-cols-2 ssm:gap-x-16">
              ...
              <Card
                logo_url={p4}
                logo_name={"Solana"}
                modalText={modalTextArr.solana}
                logo_link={modalLinks.solana}
              />
              <Card
                logo_url={p5}
                logo_name={"Pyth Network"}
                modalText={modalTextArr.pythnetwork}
                logo_link={modalLinks.pythnetwork}
              />
              <Card
                logo_url={p7}
                logo_name={"Jupiter"}
                modalText={modalTextArr.jupiter}
                logo_link={modalLinks.jupiter}
              />
              <Card
                logo_url={p6}
                logo_name={"Optimism"}
                modalText={modalTextArr.optimism}
                logo_link={modalLinks.optimism}
              />
              <Card
                logo_url={p3}
                logo_name={"Arbitrum"}
                modalText={modalTextArr.arbitrum}
                logo_link={modalLinks.arbitrum}
              />
              <Card
                logo_url={p8}
                logo_name={"Fetch.ai"}
              ...
              <Card
                logo_url={p2}
                logo_name={"InvestaX"}
                modalText={modalTextArr.investax}
                logo_link={modalLinks.investax}
              />
            </div>
          </div>
        </div>
